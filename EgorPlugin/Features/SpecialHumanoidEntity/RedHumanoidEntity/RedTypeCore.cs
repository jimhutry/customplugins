...
using EgorPlugin.Features.SpecialHumanoidEntity.OperationalSpecialEntity.Components;
using EgorPlugin.Features.SpecialHumanoidEntity.OperationalSpecialEntity.Enums;
using Exiled.Events.EventArgs.Player;
using HUD;
using static EgorPlugin.Features.SpecialHumanoidEntity.OperationalSpecialEntity.Enums.RedHumanoidEntityPowerTypes;

namespace EgorPlugin.Features.SpecialHumanoidEntity.RedHumanoidEntity;
